...
import type {Web3Provider, TransactionResponse} from "@ethersproject/providers";
...
const mapValuesToEncodedFormat = (
  ...
  async function sendModifyLiquidityTransaction(
    ...
    try {
      const data = contract.interface.encodeFunctionData("modifyLiquidity((address,address,uint24,int24,address),(int24,int24,int256),bytes)", [
        poolKey,
  ...
  export { mapValuesToEncodedFormat, mapInputFieldTypesToAbiTypes, sendModifyLiquidityTransaction, approveAndSendTransaction };