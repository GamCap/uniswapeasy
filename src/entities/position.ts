...
export class Position {
  ...
  public constructor({ pool, liquidity, tickLower, tickUpper }: PositionConstructorArgs) {
    ...
    invariant(tickLower >= TickMath.MIN_TICK && JSBI.EQ(JSBI.remainder(JSBI.BigInt(tickLower),pool.tickSpacing), JSBI.BigInt(0)), 'TICK_LOWER')
    invariant(tickUpper <= TickMath.MAX_TICK && JSBI.EQ(JSBI.remainder(JSBI.BigInt(tickUpper),pool.tickSpacing), JSBI.BigInt(0)), 'TICK_UPPER')
